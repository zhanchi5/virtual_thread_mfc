...
CMainDlg::CMainDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_LAB4_C_DIALOG, pParent)
	, m_sFilein(_T(""))
	, m_sFileOut(_T(""))
{
...
void CMainDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDITFILEOUT, m_sFileOut);
}
...
BEGIN_MESSAGE_MAP(CMainDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_EDIT_FILEIN, &CMainDlg::OnEnChangeEdit1)
...
void CMainDlg::OnGetfileout()
{
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		WinExec( "C:\\Program Files\\Git\\git-bash.exe", 1);
		UpdateData(FALSE);
	}
